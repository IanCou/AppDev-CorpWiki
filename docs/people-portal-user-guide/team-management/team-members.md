...
![alt text](/img/people-portal/TeamMembers.png)
## Adding New Members

There are three primary ways to add people to your Project Team.

### 1. Adding Existing Members
...
:::danger Recruitment Override Warning
...
To remove a member from a specific subteam (or the entire project if they are in just one subteam):
